...
static core::operations::management::search_index_control_plan_freeze_request
build_unfreeze_plan_request(std::string index_name, const unfreeze_plan_search_index_options::built& options)
{
    core::operations::management::search_index_control_plan_freeze_request request{ std::move(index_name), false, {}, options.timeout };
    return request;
}
