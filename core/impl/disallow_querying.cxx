...
static core::operations::management::search_index_control_query_request
build_disallow_querying_request(std::string index_name, const disallow_querying_search_index_options::built& options)
{
    core::operations::management::search_index_control_query_request request{ std::move(index_name), false, {}, options.timeout };
    return request;
}
                                        ...
                                        couchbase::disallow_querying_search_index_handler&& handler) const
{
    ...
    core_->execute(std::move(request),
                   [handler = std::move(handler)](core::operations::management::search_index_control_query_response resp) mutable {
