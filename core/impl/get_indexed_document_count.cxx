...
static core::operations::management::search_index_get_documents_count_request
build_get_documents_count_request(std::string index_name, const get_indexed_search_index_options::built& options)
{
    core::operations::management::search_index_get_documents_count_request request{ std::move(index_name), {}, options.timeout };
    return request;
}
