...
build_pause_ingest_request(std::string index_name, const pause_ingest_search_index_options::built& options)
{
    core::operations::management::search_index_control_ingest_request request{ std::move(index_name), true, {}, options.timeout };
    return request;
}
