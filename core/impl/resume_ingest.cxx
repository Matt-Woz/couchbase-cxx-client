...
static core::operations::management::search_index_control_ingest_request
build_resume_ingest_request(std::string index_name, const resume_ingest_search_index_options::built& options)
{
    core::operations::management::search_index_control_ingest_request request{ std::move(index_name), false, {}, options.timeout };
    return request;
}
