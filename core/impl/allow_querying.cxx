...
build_allow_querying_request(std::string index_name, const allow_querying_search_index_options::built& options)
{
    core::operations::management::search_index_control_query_request request{ std::move(index_name), true, {}, options.timeout };
    return request;
}
