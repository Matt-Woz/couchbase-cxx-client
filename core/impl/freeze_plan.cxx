...
build_freeze_plan_request(std::string index_name, const freeze_plan_search_index_options::built& options)
{
    core::operations::management::search_index_control_plan_freeze_request request{ std::move(index_name), true, {}, options.timeout };
    return request;
}
